...
export default class Helpers
{
	 ...
	 */
    static hideElementOnOutsideClick(elementToToggle, toggler, toggleClass, fadeSpeed)
    {
     ...
     */
    static printFormErrorMessage(field, error_text) 
    {
     ...
     * Do Ajax
     */
    static doAjax(url, type, dataType, data, done = null, fail = null, always = null) 
    {
        $.ajax({
            url: url,
            type: type,
     ...
     * Show/hide password
     */
    static showHidePassword($_element) 
    {
     ...
     */
    static multipleSerializeArray(form) 
    {
        let form_data = {};
     ...
     */
    static scrollToElement(elementSelector, offsetCorrection) 
    {
        let htmlAndBody = $('html, body');

        htmlAndBody.animate({
            scrollTop: (elementSelector.offset().top) + offsetCorrection
        }, 400);
    }
     ...
     */
    static addURLQueryParam(key, value)
    {
     ...
     */
    static removeURLQueryParam(key, sourceURL) 
    {
     ...
     */
    static getRandomArrayValueExcept(array, toExclude) 
    {
     ...
     */
    static parseFloatObjectValues(object)
    {
        let newObject = {};
