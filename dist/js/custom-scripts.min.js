...
/***/ "./resources/js/classes/Arborus.js":
/*!*****************************************!*\
  !*** ./resources/js/classes/Arborus.js ***!
  \*****************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Arborus; });
/* harmony import */ var uikit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! uikit */ "./node_modules/uikit/dist/js/uikit.js");
/* harmony import */ var uikit__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(uikit__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _plugins_calendar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins/calendar */ "./resources/js/classes/plugins/calendar.js");
/* harmony import */ var _plugins_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plugins/modal */ "./resources/js/classes/plugins/modal.js");
...
var Arborus = function Arborus() {
  _classCallCheck(this, Arborus);

  window.UiKit = uikit__WEBPACK_IMPORTED_MODULE_0___default.a;
  new _plugins_calendar__WEBPACK_IMPORTED_MODULE_1__["default"]();
  new _plugins_modal__WEBPACK_IMPORTED_MODULE_2__["default"]();
};
...
/***/ "./resources/js/classes/Events.js":
/*!****************************************!*\
  !*** ./resources/js/classes/Events.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _Helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Helpers */ "./resources/js/classes/Helpers.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Events = /*#__PURE__*/function () {
  ...
  _createClass(Events, [{
    ...
    value: function populateCalendar() {
      ...
      _Helpers__WEBPACK_IMPORTED_MODULE_0__["default"].doAjax('/wp-json/events/all', 'GET', 'JSON', {}, done, fail);
    }
  }]);
...
/***/ "./resources/js/classes/Helpers.js":
/*!*****************************************!*\
  !*** ./resources/js/classes/Helpers.js ***!
  \*****************************************/
/*! exports provided: default */
...
var Helpers = /*#__PURE__*/function () {
  ...
  _createClass(Helpers, null, [{
    key: "hideElementOnOutsideClick",

    /**
    * Hide element on outside click
    */
    value: function hideElementOnOutsideClick(elementToToggle, toggler, toggleClass, fadeSpeed) {
    ...
    key: "printFormErrorMessage",
    value: function printFormErrorMessage(field, error_text) {
    ...
    key: "doAjax",
    value: function doAjax(url, type, dataType, data) {
      var done = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
      var fail = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
      var always = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : null;
      $.ajax({
        url: url,
        type: type,
        dataType: dataType,
    ...
    value: function showHidePassword($_element) {
      var input = $_element.parent().find('input');
    ...
    key: "limitInputCharacters",
    value: function limitInputCharacters() {
      var fieldSelector = $('.jr-limit-characters');
      fieldSelector.on('keyup keydown', function () {
        var thisField = $(this);
        var limitIndicator = thisField.siblings('.remaining-characters');
        var maxLength = thisField.attr('maxlength');
        var limitText = limitIndicator.data('limit-text');
        var limitTextSingular = limitIndicator.data('limit-text-singular');
        var textLength = thisField.val().length;
    ...
    key: "multipleSerializeArray",
    value: function multipleSerializeArray(form) {
      var form_data = {};
      $.each(form.serializeArray(), function (index, fieldData) {
        if (fieldData.name.endsWith('[]')) {
          var name = fieldData.name.substring(0, fieldData.name.length - 2);
    ...
    key: "scrollToElement",
    value: function scrollToElement(elementSelector, offsetCorrection) {
    ...
    key: "getURLQueryParam",
    value: function getURLQueryParam(name) {
      var querySearch = document.location.search.split('+').join(' ');
      var params = {};
      var tokens = "";
      var re = /[?&]?([^=]+)=([^&]*)/g;
    ...
    key: "addURLQueryParam",
    value: function addURLQueryParam(key, value) {
    ...
    key: "removeURLQueryParam",
    value: function removeURLQueryParam(key, sourceURL) {
    ...
    key: "getRandomArrayValueExcept",
    value: function getRandomArrayValueExcept(array, toExclude) {
    ...
    key: "parseFloatObjectValues",
    value: function parseFloatObjectValues(object) {
      var newObject = {};
...
/***/ "./resources/js/classes/SocialNetworks.js":
/*!************************************************!*\
  !*** ./resources/js/classes/SocialNetworks.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SocialNetworks; });
/* harmony import */ var _Helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Helpers */ "./resources/js/classes/Helpers.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var SocialNetworks = /*#__PURE__*/function () {
  ...
  _createClass(SocialNetworks, [{
    key: "updateLinkedinPosts",
    value: function updateLinkedinPosts(e) {
      e.preventDefault();
      var thisButton = $(this);
      ...
      _Helpers__WEBPACK_IMPORTED_MODULE_0__["default"].doAjax('/wp-json/social-networks/update-linkedin-posts', 'POST', 'JSON', {}, done, fail, always);
    }
  }]);
...
/***/ "./resources/js/classes/plugins/calendar.js":
/*!**************************************************!*\
  !*** ./resources/js/classes/plugins/calendar.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var _module_jquery_simple_calendar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../module/jquery.simple-calendar.js */ "./resources/js/module/jquery.simple-calendar.js");
/* harmony import */ var _module_jquery_simple_calendar_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_module_jquery_simple_calendar_js__WEBPACK_IMPORTED_MODULE_0__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Calendar = /*#__PURE__*/function () {
  ...
  _createClass(Calendar, [{
    key: "tdClasses",
    value: function tdClasses() {
      var $td = this.$calendar.find('tbody td');
      $td.each(function () {
        var $this = $(this);
    ...
    key: "heightMatch",
    value: function heightMatch() {
      var $container = this.$calendar.closest('.wpb_row').length;
    }
  }]);
...
/***/ "./resources/js/classes/plugins/modal.js":
/*!***********************************************!*\
  !*** ./resources/js/classes/plugins/modal.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _classes_SocialNetworks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classes/SocialNetworks */ "./resources/js/classes/SocialNetworks.js");
/* harmony import */ var _classes_Arborus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes/Arborus */ "./resources/js/classes/Arborus.js");
/* harmony import */ var _classes_Events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes/Events */ "./resources/js/classes/Events.js");



window.$ = jQuery.noConflict();
$(document).ready(function () {
  new _classes_Arborus__WEBPACK_IMPORTED_MODULE_1__["default"]();
  new _classes_SocialNetworks__WEBPACK_IMPORTED_MODULE_0__["default"]();
  new _classes_Events__WEBPACK_IMPORTED_MODULE_2__["default"]();
});

/***/ }),

/***/ "./resources/js/module/jquery.simple-calendar.js":
/*!*******************************************************!*\
  !*** ./resources/js/module/jquery.simple-calendar.js ***!
  \*******************************************************/
/*! no static exports found */
...
(function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    ...
    buildCalendar: function buildCalendar(fromDate, calendar) {
      ...
      var tbody = $('<tbody></tbody>'); //Header day in a week ( (1 to 8) % 7 to start the week by monday)
    ...
    displayEvents: function displayEvents(events) {
      ...
      events.forEach(function (event) {
        ...
        var $event = $('' + '<div class="event" data-event-id="' + event.eventID + '">' + ' <div class="event-hour">' + startDate.getHours() + ':' + (startDate.getMinutes() < 10 ? '0' : '') + startDate.getMinutes() + '</div>' + ' <div class="event-date">' + plugin.formatDateEvent(startDate, endDate) + '</div>' + ' <div class="event-summary">' + event.summary + '</div>' + '</div>');
...
__webpack_require__(/*! C:\xampp\htdocs\arborus\wp-content\plugins\custom-dev\resources\js\main.js */"./resources/js/main.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\arborus\wp-content\plugins\custom-dev\resources\scss\main.scss */"./resources/scss/main.scss");
