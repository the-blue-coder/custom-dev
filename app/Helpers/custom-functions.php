 ...
 * Load template part
 */
if (!function_exists('loadTemplatePart')) {
 ...
 * Get array first key
 */
if (!function_exists('getArrayFirstKey')) {
 ...
 */
if (!function_exists('underscoresToHyphen')) {
 ...
 */
if (!function_exists('hyphenToUnderscores')) {
 ...
 */
if (!function_exists('getCSSPropertyValueFromString')) {
 ...
 */
if (!function_exists('getRotateValueFromTransformString')) {
 ...
 */
if (!function_exists('specialCharactersToUrlValue')) {
 ...
 */
if (!function_exists('generatePostFeaturedImageFromImagePath')) {
 ...
 */
if (!function_exists('wrapHashtag')) {
